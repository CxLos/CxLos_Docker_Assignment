...
def test_hello_world(page, fastapi_server):
    ...
    assert page.inner_text('h1') == 'Hello World 2'
...
def test_calculator_add(page, fastapi_server):
    ...
    # Wait for the result to appear in the DOM before asserting.
    page.wait_for_selector('#result:has-text("Calculation Result")')
...
def test_calculator_divide_by_zero(page, fastapi_server):
    ...
    # Wait for the error message to appear in the DOM before asserting.
